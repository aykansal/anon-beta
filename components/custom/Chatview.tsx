                ...
                >
                  {msg.isLoading ? (
                    <div className="flex items-center justify-center">
                      <Loader2Icon className="animate-spin text-gray-400" size={18} />
                    </div>
                  ) : (
    ...
    <div className="flex items-center gap-2 mb-2">
      {showLuaToggle && (
        <label className="flex items-center gap-1.5 cursor-pointer">
          <span className="text-xs font-medium text-gray-600">Lua</span>
          <div className="relative">
            <input
              ...
              className="sr-only"
            />
            <div className="w-7 h-3 bg-gray-200 rounded-full shadow-inner transition-colors duration-200 ease-in-out" />
            <div
    ...
    <form onSubmit={handleSubmit} className="w-full">
      <div className="flex gap-2 items-start">
        <select
          ...
          className="bg-white border border-gray-300 rounded-md px-2 py-1 text-gray-800 h-[44px] shrink-0"
        >
        ...
        <button
          type="submit"
          className="bg-green-600 text-white px-4 py-2 rounded-md disabled:opacity-50 h-[44px] flex items-center justify-center shrink-0"
