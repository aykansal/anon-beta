...
const StatusBar = ({
  ...
  return (
    <div className="h-8 shrink-0 bg-white border-t border-gray-200 px-4 flex items-center text-xs font-medium text-gray-700">
    ...
    <div className="flex items-center gap-2">
      {connectionStatus === 'connected' && (
        <>
          <div className="w-2 h-2 rounded-full bg-blue-600 shadow-[0_0_6px] shadow-blue-500"></div>
      ...
      {connectionStatus === 'disconnected' && (
        <>
          <div className="w-2 h-2 rounded-full bg-red-500 shadow-[0_0_6px] shadow-red-400"></div>
