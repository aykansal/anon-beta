...
const Footer = ({ mounted, theme, setTheme }) => {
  return (
        ...
        <div className="flex flex-col space-y-5">
          ...
          <div className="flex flex-col md:flex-row justify-between gap-6">
            ...
            <div className="flex items-center">
              <div className="flex items-center text-foreground/90">
                <span className="font-mono text-xs text-primary mr-1">{">"}</span>
            ...
            <div className="flex items-center">
              ...
              />
              <button className="bg-primary/90 hover:bg-primary text-primary-foreground px-3 py-1.5 rounded-r-md text-sm font-medium transition-colors">
                Subscribe
              </button>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center pt-4 border-t border-border/30">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a href="#" className="p-1.5 rounded-full hover:bg-primary/10 transition-colors" aria-label="Twitter">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              <a href="#" className="p-1.5 rounded-full hover:bg-primary/10 transition-colors" aria-label="GitHub">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              <a href="#" className="p-1.5 rounded-full hover:bg-primary/10 transition-colors" aria-label="Discord">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
